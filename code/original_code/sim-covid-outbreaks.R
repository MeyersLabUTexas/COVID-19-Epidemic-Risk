...
get_save_path <- function(r_not, 
                          ...
                          summary = FALSE){
  if(summary){
    paste0(dir_path, "/county-summary_", r_not, "_", detection_probability, "_", importation_rate, "_", num_reps, ".rda")
  }else {
    paste0(dir_path, "/sim_", r_not, "_", detection_probability, "_", importation_rate, "_", num_reps, ".rda")  
  }
}
